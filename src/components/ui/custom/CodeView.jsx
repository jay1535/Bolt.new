...
function CodeView() {
  ...
  return (
    <div className="border-none rounded-2xl relative">
        ...
        <div className="flex items-center justify-center flex-wrap shrink-0 bg-gray-900 p-1 w-[140px] border rounded-full gap-3 ">
          <h2
            ...
            className={`text-sm cursor-pointer ${
              activeTab === "code" && "text-blue-600 p-1 px-2 rounded-full"
            }`}
          >
            Code
          </h2>
          <h2
            ...
            className={`text-sm cursor-pointer ${
              activeTab === "preview" && "text-blue-600 p-1 px-2 rounded-full"
            }`}
          >
            Preview
          </h2>
      ...
      {loading && (
        <div className="p-10 bg-black opacity-80 absolute top-0 rounded-lg w-full h-full flex items-center justify-center">
          <Loader
